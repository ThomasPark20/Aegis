...
- **Research on demand** — ask AEGIS to research any threat. It spins up a Discord thread, investigates primary sources, extracts IOCs, maps TTPs, and delivers a structured report.
