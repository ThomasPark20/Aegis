...
This skill adds Slack support to AEGIS, then walks through interactive setup.
...
```bash
git remote add slack https://github.com/qwibitai/aegis-slack.git
```
...
>
> The JID format for AEGIS is: `slack:C0123456789`
...
6. Restart: `launchctl kickstart -k gui/$(id -u)/com.aegis`
