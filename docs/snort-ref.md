...
| `metadata` | Key-value metadata | `metadata:author AEGIS, created 2026-04-01;` |
...
alert http $HOME_NET any -> $EXTERNAL_NET any (
    msg:"AEGIS - HTTP C2 Beacon Check-in to /api/update Endpoint";
    ...
    metadata:author AEGIS, created 2026-04-01;
    sid:2100001;
    rev:1;
)
```
...
alert dns $HOME_NET any -> any $DNS_PORTS (
    msg:"AEGIS - DNS Query to Known C2 Domain evil-update[.]xyz";
    flow:to_server;
    dns.query;
...
alert tls $HOME_NET any -> $EXTERNAL_NET any (
    msg:"AEGIS - TLS Connection to Self-Signed C2 with Anomalous CN";
    flow:established, to_server;
    tls.sni;
